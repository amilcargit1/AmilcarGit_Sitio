...
const translations = {
  ...
  phApodo: { es: 'Tu apodo (se muestra en tus canciones)', en: 'Your nickname (shown on your songs)' },
    ...
    nicknameSaveBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        await db.runTransaction(async (tx) => {
          ...
          tx.set(metaRef, { count, nickname: newNickname });
        });
